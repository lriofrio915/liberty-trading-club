...
export const metadata = {
  ...
  description:
    "Manual detallado de la estrategia de trading para futuros E-mini S&P 500 (ES).",
};
...
export default function ManualESPage() {
  return (
    <div className="container mx-auto p-8 pt-1 max-w-4xl relative">
      <ScrollToTopButton />
      {/* Contenido de la "Página 1" - Idéntico al manual de Nasdaq/MES */}
      <div className="bg-white rounded-lg shadow-xl mb-8 p-10 relative">
        <div className="min-h-[calc(100vh-120px)]">
          ...
          <h1 className="text-3xl font-bold text-center text-gray-800 mb-4">
            Estrategia de Trading Intradía para Futuros E-mini S&P 500:
          </h1>
          ...
          <p className="mb-4 text-justify">
            ...
            estrategia de trading intradía aplicada a los futuros E-mini S&P 500
            (ES) en la plataforma NinjaTrader 8. La estrategia se fundamenta en
            un enfoque de dos etapas: primero, un análisis del contexto
            macroeconómico fundamental para determinar una dirección clara del
            sesgo de operación (compra o venta) para el día; y segundo, la
            aplicación de patrones técnicos del método Wyckoff, identificados
            mediante el indicador Order Flow Volumen Profile, EMA 52, SMA 80 y
            MACD Bollinger Bands, para el timing preciso de entrada al mercado.
          </p>
          <p className="mb-4 text-justify">
          ...
          <p className="mb-4 text-justify">
            La gestión de riesgos, anclada en la regla del 2% y stops de pérdida
            fijos, es fundamental para la preservación del capital. Se
            identifican áreas clave para la optimización y la investigación
            futura, incluyendo la cuantificación de los factores de sentimiento
            macroeconómico y la adaptación dinámica de los parámetros de riesgo
          ...
          <p className="mb-4 text-justify">
            El trading intradía en mercados de futuros, como el E-mini S&P 500
            (ES), ofrece oportunidades significativas de capitalización debido a
            su alta liquidez y volatilidad. Sin embargo, el éxito sostenido en
            este entorno requiere una estrategia robusta y bien definida.
          </p>
          <p className="mb-4 text-justify">
            Este estudio presenta una metodología de trading innovadora que
            integra el análisis macroeconómico fundamental con patrones técnicos
            de entrada, buscando optimizar la toma de decisiones y mejorar la
            consistencia de los resultados.
          </p>
          <p className="mb-4 text-justify">
            A diferencia de enfoques puramente técnicos, esta estrategia propone
            una visión holística del mercado. La primera etapa consiste en una
            evaluación profunda del contexto macroeconómico global y,
            específicamente, de los factores que influyen en el índice S&P 500.
          </p>
        </div>
      ...
      {/* Contenido de la "Página 2" - Adaptado para el ES */}
      <div className="bg-white rounded-lg shadow-xl mb-8 p-10 relative">
        <div className="min-h-[calc(100vh-120px)]">
          <p className="mb-4 text-justify">
            Esta evaluación permite establecer una dirección operativa
            predominante para el día (alcista o bajista), alineando las
            operaciones con el flujo general del mercado. Una vez definida esta
            dirección, la segunda etapa se centra en la identificación de
            patrones técnicos específicos en el gráfico de precios para
            determinar el momento óptimo de entrada.
          </p>
          <p className="mb-4 text-justify">
            El objetivo de esta investigación es validar la efectividad de esta
            estrategia integrada en términos de rentabilidad, su capacidad de
            ser replicada por otros operadores y la facilidad con la que puede
            ser enseñada.
          </p>
          <h3 className="text-2xl font-semibold text-gray-900 mt-6 mb-4 pb-2 border-b-2 border-gray-200">
            2. Marco Teórico
          ...
          <p className="mb-4 text-justify">
            ...
            intrínsecamente ligado a las condiciones macroeconómicas. El S&P
            500, al ser un índice de 500 empresas de gran capitalización, es
          ...
          <h4 className="text-xl font-semibold text-gray-800 mt-5 mb-3">
            2.2. Análisis Técnico: Order Flow, EMA 52, SMA 80 y MACD Bollinger
            Bands
          </h4>
          <p className="mb-4 text-justify">
            ...
            precisos. Utilizamos una combinación de indicadores para confirmar
            la fuerza del movimiento y la validez de la zona de entrada.
          </p>

          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">
              <strong className="font-semibold">
                Order Flow Volumen Profile:
              </strong>
              Este indicador de NinjaTrader 8 es fundamental para identificar
              zonas de alto y bajo interés, o puntos de máximo y mínimo valor.
              Estas zonas actúan como soportes y resistencias importantes,
              siendo &quot;imanes&quot; para el precio. También nos proporciona el Punto
              de Control (POC), un nivel de precio justo.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">
                EMA 52 (Midband de Keltner Channel) y SMA 80:
              </strong>
              Estas medias móviles son clave. La EMA 52 (Midband) es parte del
              Keltner Channel y la SMA 80 (color morado) acompaña el movimiento
              del precio, sirviendo como soportes o resistencias dinámicos.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">MACD Bollinger Bands:</strong>
              Este indicador nos ayuda a determinar la fuerza y la intención de
              un rompimiento de zona. Buscamos que las Bollinger Bands del MACD
              se encuentren sobre el nivel +3 o bajo el nivel -3 del indicador
              para confirmar un movimiento con fuerza.
            </li>
          </ul>

          <h4 className="text-xl font-semibold text-gray-800 mt-5 mb-3">
            2.3. Proceso de Entrada (Confluencia de Indicadores)
          </h4>
          <p className="mb-4 text-justify">
            Para tomar una compra o venta, buscamos que el precio tenga un
            soporte o resistencia clave en el <b>Midband (EMA 52)</b>, la <b>SMA
            80</b> o una <b>zona de valor del Volumen Profile</b>. La entrada se
            busca a favor de la dirección de un impulso fuerte del precio en
            estas zonas de valor identificadas.
          </p>
          <Image
            src="https://i.ibb.co/4gDqMb8D/vol-profile.jpg"
            alt="Áreas de Valor para identificación de zonas importantes"
          ...
          <Image
            src="https://i.ibb.co/KjWB3bmv/ES-completp.jpg"
            alt="Indicadores técnicos sma, ema, macd"
            className="max-w-full h-auto mx-auto my-4 block rounded-md shadow-md"
            width={700}
            height={400}
          />
          <h3 className="text-xs text-center mb-4">
            Gráfico 3. Confluencia de Indicadores
          </h3>
        </div>
        <div className="flex justify-between pt-4 mt-6 border-t border-gray-200 text-sm text-gray-600">
          <span>Liberty Trading Club</span>
      ...
      {/* Contenido de la "Página 3" - Gestión de Riesgos y Ejecución */}
      <div className="bg-white rounded-lg shadow-xl mb-8 p-10 relative">
        <div className="min-h-[calc(100vh-120px)]">
          <h3 className="text-2xl font-semibold text-gray-900 mt-6 mb-4 pb-2 border-b-2 border-gray-200">
          ...
          <p className="mb-4 text-justify">
            ...
            del capital en la estrategia ES:
          </p>

          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">
              <strong className="font-semibold">Regla del 2%:</strong> El riesgo
              máximo por operación no debe exceder el 2% del capital total de la
              cuenta de trading.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">
                Stop-Loss Activo hasta Breakeven:
              </strong>
              Gestionamos el stop loss de forma activa, moviéndolo detrás de
              cada pivote importante a medida que el precio se mueve a nuestro
              favor, <b>únicamente hasta alcanzar el breakeven</b>. Una vez en
              breakeven, el stop no se mueve más. El riesgo asumido es de 2 puntos por contrato.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">Take Profit:</strong> El
              objetivo de ganancia se establece en niveles basados en una
              relación riesgo-recompensa de <b>1:3</b>, buscando un mayor retorno
              por cada unidad de riesgo asumida.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">Horario de Operación:</strong>{" "}
              Buscamos oportunidades de compra o venta en las dos primeras horas
              de la apertura del mercado americano.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">Frecuencia:</strong> Solo
              tomamos una entrada al día, a menos que la operación inicial
              termine en breakeven y las condiciones de entrada se repitan.
            </li>
          </ul>
          ...
          <Image
            ...
            alt="Planificación de entrada"
            className="max-w-full h-auto mx-auto my-6 block rounded-md shadow-md"
            width={700}
            height={400}
          />
          <h3 className="text-xs text-center mb-4">
            Gráfico 4. Entrada de compra en la zona del MidBand y Volumen Profile
          </h3>
          ...
          <Image
            src="https://i.ibb.co/KCFd1QC/ejemplo-de-venta.png"
          ...
          />
          <h3 className="text-xs text-center mb-4">
            Gráfico 5. Entrada en venta en zona de interés del Volumen Profile.
          </h3>
        </div>
        <div className="flex justify-between pt-4 mt-6 border-t border-gray-200 text-sm text-gray-600">
          <span>Liberty Trading Club</span>
      ...
      {/* Contenido de la "Página 4" - Idéntico al manual de Nasdaq/MES */}
      <div className="bg-white rounded-lg shadow-xl mb-8 p-10 relative">
        <div className="min-h-[calc(100vh-120px)]">
          <h3 className="text-2xl font-semibold text-gray-900 mt-6 mb-4 pb-2 border-b-2 border-gray-200">
          ...
          <p className="mb-4 text-justify">
            ...
            riguroso backtesting sobre datos históricos del ES, complementado
            con pruebas en tiempo real. Se ha observado que los días con una
            dirección macroeconómica clara y un fuerte catalizador tienden a
            producir las operaciones más exitosas, mientras que los días de
            incertidumbre macroeconómica o consolidación pueden generar señales
            falsas o un rendimiento inferior.
          </p>
          <p className="mb-4 text-justify">
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">
              ...
              Mide la rentabilidad global de la estrategia durante el período de
              backtesting.
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">
              ...
              Representa la mayor caída de la equidad de la cuenta desde un pico
              hasta un mínimo posterior.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">
            ...
            <li className="mb-2">
              <strong className="font-semibold">Consistencia:</strong> Evalúa si
              la estrategia mantiene su rendimiento en diferentes condiciones de
              mercado.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">Número de Operaciones:</strong>
          ...
          <p className="mb-4 text-justify">
            La estrategia de trading intradía para futuros E-mini S&P 500,
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">
              ...
              Desarrollar un sistema más objetivo y automatizado o un índice
              para cuantificar el &quot;sentimiento macro&quot; y la dirección.
            </li>
            <li className="mb-2">
              <strong className="font-semibold">
            ...
            <li className="mb-2">
              <strong className="font-semibold">Automatización Parcial:</strong>
            ...
            <li className="mb-2">
              ...
              Profundizar en el estudio de las correlaciones entre el ES y otros
              activos.
            </li>
          </ul>
      ...
      <div className="bg-white rounded-lg shadow-xl mb-8 p-10 relative">
        <div className="min-h-[calc(100vh-120px)]">
          ...
          <p className="mb-4 text-justify">
            En esta sección se presentan ejemplos de operaciones que finalizaron
            con un resultado positivo (take profit).
          </p>
          ...
          <p className="mb-4 text-xs text-center">
            Descripción: Ejemplo de entrada en zona de interés compradora.
          </p>
          ...
          <p className="mb-4 text-center text-xs">
            Descripción: Ejemplo de entrada de venta en zona de interés.
          </p>
          ...
          <p className="mb-4 text-justify">
            En esta sección se presentan ejemplos de operaciones que finalizaron
            con un resultado negativo (stop loss).
          </p>
          ...
          />
          <p className="mb-4 text-center text-xs">
            Descripción: El precio no se desarrolla a favor y cae directamente
            hacia el stop, respetando la gestión de riesgo.
          </p>
          <h4 className="text-xl font-semibold text-gray-800 mt-5 mb-3">
            (b) Venta (Ejemplo)
          </h4>
          ...
          />
          <p className="mb-4 text-center text-xs">
            Descripción: El precio no se desarrolla a favor y sube directamente
            hacia el stop, respetando la gestión de riesgo.
          </p>
        </div>
        <div className="flex justify-between pt-4 mt-6 border-t border-gray-200 text-sm text-gray-600">
