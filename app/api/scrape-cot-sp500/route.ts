// app/api/scrape-cot-sp500/route.ts
...
export async function GET() {
  ...
  try {
    ...
    if (longChange === null || shortChange === null || actualValue === null) {
      console.warn(
        "No se pudieron extraer los datos de Sentimiento COT del S&P 500 (Large Speculators)."
      );
      return NextResponse.json<ScrapedData>(
        {
          error:
            "No se pudieron extraer los datos de Sentimiento COT del S&P 500.",
    ...
    console.error(
      "Error al hacer scraping de Sentimiento COT S&P 500:",
      errorMessage
    );
    ...
    const specificErrorMsg =
      status === 403
        ...
        : `Fallo al obtener datos de Sentimiento COT S&P 500: ${errorMessage}`;
